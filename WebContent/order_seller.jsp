...
<%
	...
	ArrayList<orderItem> orderItems = seller.getOrder(sellerId);
...
<body>
	...
	<script>
		function checkOrder()
	    {
	        ...
	        if($("input[name='checkbox']:checked").length == 0){
	            ...
	            document.order_sellerForm.action = "checkOrderServlet";
	            document.order_sellerForm.submit();
	        }
		...
		function cancelOrder()
	    {
	        ...
	        if($("input[name='checkbox']:checked").length == 0){
	            ...
	            document.order_sellerForm.action = "cancelOrderServlet";
	            document.order_sellerForm.submit();
	        }
		...
		function finishOrder()
	    {
	        ...
	        if($("input[name='checkbox']:checked").length == 0){
	            ...
	            document.order_sellerForm.action = "finishOrderServlet";
	            document.order_sellerForm.submit();
	        }
    ...
    <!-- 內容區 -->
	<div id="order_seller_content" class="content">
	    <div class="topic">商品訂單(賣家)</div>
	    <div class="content_container">
	        <!-- 這邊form表單傳遞參數你們要自己寫，看要怎麼把所有商品的參數都傳過去 -->
	        <form id="order_sellerForm" name="order_sellerForm" class="center"">
	            ...
	            <div class="content_settlement center text_center">
	                <div class="col-md-6 center">
	                	<button type="button" class="btn btn-primary" onclick="checkOrder()">確認訂單</button>
	                    <button type="button" class="btn btn-primary" onclick="cancelOrder()">取消訂單</button>
	                    <button type="button" class="btn btn-primary" onclick="finishOrder()">已移交</button>
	                </div>
	            </div>
	        </form>
